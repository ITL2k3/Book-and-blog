            ...
            <div className="modal-add-ovl">
                    <div className="modal3" style={ { top: '50%', left: '50%', transform: 'translate(-50%, -50%)' } }>
                        <div className="modal-content3">
                            <h4>Báo cáo</h4>
                            <p>Người dùng <b>{clickedNoti.user_id}</b> báo cáo tài liệu <b>{clickedNoti.book_id}</b> của tác giả <b> {clickedNoti.author_id}</b>: </p>
                ...
                <div className="notify-container">
                    ...
                    { notifications.map(ntf => {
                        return <div className="ntf-item" onClick={() => handleNotiItemClick(ntf)} >
                            ...
                            <div id="ntf-us-id"> Người dùng { ntf.user_id } báo cáo tài liệu</div>
