            ...
            <div className="login">
                ...
                <div className="login-content">
                    ...
                    <Form method='post' action="/access">
                        ...
                        <label for="dropdown" style={{display: 'flex', justifyContent:'space-between', marginTop: "5px"}}>Bạn là:
                            <select id="dropdown" onchange="showOption()" name='role' required style={{paddingLeft: "10px", paddingRight: "10px", paddingTop:"2px", paddingBottom: "2px"}}>
...
export const loginAction = async (submission) => {
    ...
    const loginURL = `http://${host}:3055/v1/api/login`
